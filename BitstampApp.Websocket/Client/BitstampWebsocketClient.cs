...
using BitstampApp.Websocket.Responses;
using BitstampApp.Websocket.Responses.Books;
using BitstampApp.Websocket.Responses.Orders;
using BitstampApp.Websocket.Validations;
using Newtonsoft.Json.Linq;
using Websocket.Client;

namespace BitstampApp.Websocket.Client
{
    /// <summary>
